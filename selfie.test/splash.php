  ...
  You've been Entered! Good Luck!
   ...
   <div style="position:relative;width:100%;height:100%;text-align:center;color:#fff;font-size:30px;">
        ...
        <?php if($image != ''){?>
          ...
          <div style="position:absolute;top:67%;width:100%;">
...
<a href="https://saltydogcafe.com/selfie.test/" class="discard button button-big  active color-red" style="margin-top:0px;width:44%;float:left;margin-left:5%;">Discard</a>
