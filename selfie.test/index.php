              ...
              <div class="content-block">
                <div class="content-block-inner">
                 ...
                 <!-- <div style="width:100%;color:#fff !important;text-align:center;position:relative;top:50px;">
                  <div class="fb-like" data-href="https://saltydogcafe.com/selfie.test/" data-width="200" data-layout="button" data-action="like" data-show-faces="true" data-share="true"></div>
                   </div>-->
                  <div id="mess">
...
function killSession() {
    ...
    xhr.send();
        ...
        audioElement.setAttribute('src', 'https://saltydogcafe.com/selfie.test/src/shutter.mp3');
